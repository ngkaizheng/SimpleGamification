...
// export default class Sky extends Node {
...
//         //Find any existing skybox and dispose it
//         const existingSkybox = scene.getMeshByName("sky");
//         if (existingSkybox) {
//             existingSkybox.dispose();
//             console.log("Existing skybox disposed");
//         }
...
//         skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("/assets/materials/skybox/skybox", scene);
//         skyboxMaterial.reflectionTexture.coordinatesMode = BABYLON.Texture.SKYBOX_MODE;
//         skyboxMaterial.diffuseColor = new BABYLON.Color3(0, 0, 0);
//         skyboxMaterial.specularColor = new BABYLON.Color3(0, 0, 0); skybox.material = skyboxMaterial;

//         // // Create skybox
//         // this._skybox = BABYLON.CreateBox("skyBox", { size: 1000.0 }, scene);
...
//         // // Load textures
//         // this._skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture(this._morningTexturePath, scene);
